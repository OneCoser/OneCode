package chenhao.lib.onecode.view.aviloading;
...
public class AVLoadingIndicatorView extends View {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.OneCodeRefreshView);
        mIndicatorId=a.getInt(R.styleable.OneCodeRefreshView_avlv_style, BallPulse);
        mIndicatorColor=a.getColor(R.styleable.OneCodeRefreshView_avlv_color, Color.WHITE);
        a.recycle();
        mPaint=new Paint();
