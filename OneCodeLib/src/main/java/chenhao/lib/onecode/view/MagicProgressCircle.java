...
public class MagicProgressCircle extends View {
    ...
    private void init(final Context context, final AttributeSet attrs) {
        ...
        strokeWidth = (int) (8 * getResources().getDisplayMetrics().density + 0.5f);
        percent = defaultPercent;
        startColor = Color.parseColor("#aaffffff");
        ...
        try {
            ...
            strokeWidth = (int) typedArray.getDimension(R.styleable.MagicProgressCircle_mpc_stroke_width, strokeWidth);
